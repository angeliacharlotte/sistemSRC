                        ...
                        <tbody>
                            ...
                            foreach($barang as $brg){ ?>
                                <tr>
                                    ...
                                    <td style="vertical-align: middle;" class="text-center"><?= number_format($brg['harga_beli'],0,',','.' )?></td>
                                    <td style="vertical-align: middle;" class="text-center"><?= number_format($brg['harga_jual'],0,',','.' )?></td>
