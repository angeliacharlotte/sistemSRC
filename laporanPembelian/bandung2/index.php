...
if(empty($_GET['tanggal_dari'])) {  
  ...
  $result = mysqli_query($koneksi,"SELECT tbl_beli_detail_bandung2.*, tbl_beli_head_bandung2.suplier, tbl_beli_head_bandung2.keterangan,  tbl_beli_head_bandung2.total
        FROM tbl_beli_detail_bandung2 JOIN tbl_beli_head_bandung2 ON tbl_beli_detail_bandung2.no_beli = tbl_beli_head_bandung2.no_beli WHERE tbl_beli_detail_bandung2.tgl_beli = '$tanggal_hari_ini' ORDER BY tbl_beli_detail_bandung2.tgl_beli DESC");
}else if(empty($_GET['tanggal_sampai'])){
  $tanggal_dari = $_GET['tanggal_dari'];
  $tanggal_hari_ini = date('Y-m-d');
//   $tanggal_sampai = $_GET['tanggal_sampai'];
  $result = mysqli_query($koneksi,"SELECT tbl_beli_detail_bandung2.*, tbl_beli_head_bandung2.suplier, tbl_beli_head_bandung2.keterangan,  tbl_beli_head_bandung2.total
        FROM tbl_beli_detail_bandung2 JOIN tbl_beli_head_bandung2 ON tbl_beli_detail_bandung2.no_beli = tbl_beli_head_bandung2.no_beli WHERE tbl_beli_detail_bandung2.tgl_beli BETWEEN '$tanggal_dari' AND '$tanggal_hari_ini' ORDER BY tbl_beli_detail_bandung2.tgl_beli DESC");
}else{
    $tanggal_dari = $_GET['tanggal_dari'];
  $tanggal_sampai = $_GET['tanggal_sampai'];
  $result = mysqli_query($koneksi,"SELECT tbl_beli_detail_bandung2.*, tbl_beli_head_bandung2.suplier, tbl_beli_head_bandung2.keterangan,  tbl_beli_head_bandung2.total
        FROM tbl_beli_detail_bandung2 JOIN tbl_beli_head_bandung2 ON tbl_beli_detail_bandung2.no_beli = tbl_beli_head_bandung2.no_beli WHERE tbl_beli_detail_bandung2.tgl_beli BETWEEN '$tanggal_dari' AND '$tanggal_sampai' ORDER BY tbl_beli_detail_bandung2.tgl_beli DESC");
}
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Laporan Pembelian Area Bandung 2</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
        ...
        <form method="POST" action="<?= $main_url ?>laporanPembelian/bandung2/rekap_pembelian_excel.php">
