...
if(empty($_GET['tanggal_dari'])) {  
  ...
  $result = mysqli_query($koneksi,"SELECT tbl_beli_detail_tangerang.*, tbl_beli_head_tangerang.suplier, tbl_beli_head_tangerang.keterangan,  tbl_beli_head_tangerang.total
        FROM tbl_beli_detail_tangerang JOIN tbl_beli_head_tangerang ON tbl_beli_detail_tangerang.no_beli = tbl_beli_head_tangerang.no_beli WHERE tbl_beli_detail_tangerang.tgl_beli = '$tanggal_hari_ini' ORDER BY tbl_beli_detail_tangerang.tgl_beli DESC");
}else if(empty($_GET['tanggal_sampai'])){
  $tanggal_dari = $_GET['tanggal_dari'];
  $tanggal_hari_ini = date('Y-m-d');
//   $tanggal_sampai = $_GET['tanggal_sampai'];
  $result = mysqli_query($koneksi,"SELECT tbl_beli_detail_tangerang.*, tbl_beli_head_tangerang.suplier, tbl_beli_head_tangerang.keterangan,  tbl_beli_head_tangerang.total
        FROM tbl_beli_detail_tangerang JOIN tbl_beli_head_tangerang ON tbl_beli_detail_tangerang.no_beli = tbl_beli_head_tangerang.no_beli WHERE tbl_beli_detail_tangerang.tgl_beli BETWEEN '$tanggal_dari' AND '$tanggal_hari_ini' ORDER BY tbl_beli_detail_tangerang.tgl_beli DESC");
}else{
    $tanggal_dari = $_GET['tanggal_dari'];
  $tanggal_sampai = $_GET['tanggal_sampai'];
  $result = mysqli_query($koneksi,"SELECT tbl_beli_detail_tangerang.*, tbl_beli_head_tangerang.suplier, tbl_beli_head_tangerang.keterangan,  tbl_beli_head_tangerang.total
        FROM tbl_beli_detail_tangerang JOIN tbl_beli_head_tangerang ON tbl_beli_detail_tangerang.no_beli = tbl_beli_head_tangerang.no_beli WHERE tbl_beli_detail_tangerang.tgl_beli BETWEEN '$tanggal_dari' AND '$tanggal_sampai' ORDER BY tbl_beli_detail_tangerang.tgl_beli DESC");
}
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Laporan Pembelian Area Tangerang</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
        ...
        <form method="POST" action="<?= $main_url ?>laporanPembelian/tangerang/rekap_pembelian_excel.php">
