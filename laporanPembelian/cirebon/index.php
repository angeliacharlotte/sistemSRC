...
if(empty($_GET['tanggal_dari'])) {  
  ...
  $result = mysqli_query($koneksi,"SELECT tbl_beli_detail_cirebon.*, tbl_beli_head_cirebon.suplier, tbl_beli_head_cirebon.keterangan,  tbl_beli_head_cirebon.total
        FROM tbl_beli_detail_cirebon JOIN tbl_beli_head_cirebon ON tbl_beli_detail_cirebon.no_beli = tbl_beli_head_cirebon.no_beli WHERE tbl_beli_detail_cirebon.tgl_beli = '$tanggal_hari_ini' ORDER BY tbl_beli_detail_cirebon.tgl_beli DESC");
}else if(empty($_GET['tanggal_sampai'])){
  $tanggal_dari = $_GET['tanggal_dari'];
  $tanggal_hari_ini = date('Y-m-d');
//   $tanggal_sampai = $_GET['tanggal_sampai'];
  $result = mysqli_query($koneksi,"SELECT tbl_beli_detail_cirebon.*, tbl_beli_head_cirebon.suplier, tbl_beli_head_cirebon.keterangan,  tbl_beli_head_cirebon.total
        FROM tbl_beli_detail_cirebon JOIN tbl_beli_head_cirebon ON tbl_beli_detail_cirebon.no_beli = tbl_beli_head_cirebon.no_beli WHERE tbl_beli_detail_cirebon.tgl_beli BETWEEN '$tanggal_dari' AND '$tanggal_hari_ini' ORDER BY tbl_beli_detail_cirebon.tgl_beli DESC");
}else{
    $tanggal_dari = $_GET['tanggal_dari'];
  $tanggal_sampai = $_GET['tanggal_sampai'];
  $result = mysqli_query($koneksi,"SELECT tbl_beli_detail_cirebon.*, tbl_beli_head_cirebon.suplier, tbl_beli_head_cirebon.keterangan,  tbl_beli_head_cirebon.total
        FROM tbl_beli_detail_cirebon JOIN tbl_beli_head_cirebon ON tbl_beli_detail_cirebon.no_beli = tbl_beli_head_cirebon.no_beli WHERE tbl_beli_detail_cirebon.tgl_beli BETWEEN '$tanggal_dari' AND '$tanggal_sampai' ORDER BY tbl_beli_detail_cirebon.tgl_beli DESC");
}
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Laporan Pembelian Area Cirebon</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
        ...
        <form method="POST" action="<?= $main_url ?>laporanPembelian/cirebon/rekap_pembelian_excel.php">
