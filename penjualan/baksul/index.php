...
if($msg == 'deleted'){
    ...
    $qty = $_GET['qty'];
    $tgl = $_GET['tgl'];
    delete_baksul($idbrg, $idjual, $qty);
    echo "<script>
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Penjualan Barang Area Baksul</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                     ...
                     <div class="col-lg-6">
                        <div class="card card-outline card-danger pt-3 px-3 pb-2">
                            ...
                            <h1 class="font-weight-bold text-right" style="font-size: 40pt;">
                                <input type="hidden" id="total" name="total" value="<?= totalJual_baksul($noJual) ?>">
                                <?= number_format(totalJual_baksul($noJual), 0,',','.') ?>
                        </h1>
                        </div>
                    </div>
                </div>
                 ...
                 <div class="card card-outline card-success table-responsive px-2">
                    <table class="table table-sm table-hover text-nowrap">
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            $brgDetail = getData("SELECT * FROM tbl_jual_detail_baksul WHERE no_jual ='$noJual'");
