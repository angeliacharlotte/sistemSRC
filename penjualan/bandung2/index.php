...
if($msg == 'deleted'){
    ...
    $qty = $_GET['qty'];
    $tgl = $_GET['tgl'];
    delete_bandung2($idbrg, $idjual, $qty);
    echo "<script>
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Penjualan Barang Area Bandung 2</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                     ...
                     <div class="col-lg-6">
                        <div class="card card-outline card-danger pt-3 px-3 pb-2">
                            ...
                            <h1 class="font-weight-bold text-right" style="font-size: 40pt;">
                                <input type="hidden" id="total" name="total" value="<?= totalJual_bandung2($noJual) ?>">
                                <?= number_format(totalJual_bandung2($noJual), 0,',','.') ?>
                        </h1>
                        </div>
                    </div>
                </div>
                 ...
                 <div class="card card-outline card-success table-responsive px-2">
                    <table class="table table-sm table-hover text-nowrap">
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            $brgDetail = getData("SELECT * FROM tbl_jual_detail_bandung2 WHERE no_jual ='$noJual'");
