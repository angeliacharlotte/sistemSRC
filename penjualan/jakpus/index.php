...
if($msg == 'deleted'){
    ...
    $qty = $_GET['qty'];
    $tgl = $_GET['tgl'];
    delete_jakpus($idbrg, $idjual, $qty);
    echo "<script>
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Penjualan Barang Area Jakarta Pusat</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                     ...
                     <div class="col-lg-6">
                        <div class="card card-outline card-danger pt-3 px-3 pb-2">
                            ...
                            <h1 class="font-weight-bold text-right" style="font-size: 40pt;">
                                <input type="hidden" id="total" name="total" value="<?= totalJual_jakpus($noJual) ?>">
                                <?= number_format(totalJual_jakpus($noJual), 0,',','.') ?>
                        </h1>
                        </div>
                    </div>
                </div>
                 ...
                 <div class="card card-outline card-success table-responsive px-2">
                    <table class="table table-sm table-hover text-nowrap">
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            $brgDetail = getData("SELECT * FROM tbl_jual_detail_jakpus WHERE no_jual ='$noJual'");
                    ...
                    <div class="col-lg-4 p-2">
                        ...
                        <div class="col-sm-9">
                            <select name="customer" id="customer" class="form-control form-control-sm">
                                ...
                                <?php 
                                        $customers = getData("SELECT *  FROM tbl_customer_jakpus");
