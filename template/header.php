...
<head>
  ...
  <!-- DataTables -->
  <link rel="stylesheet" href="<?= $main_url ?>asset/AdminLTE-3.2.0/AdminLTE-3.2.0/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css">
   <!-- SweetAlert2 -->
  <link rel="stylesheet" href="<?= $main_url ?>asset/AdminLTE-3.2.0/AdminLTE-3.2.0/plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css">
  <!-- jQuery -->
<script src="<?= $main_url ?>asset/AdminLTE-3.2.0/AdminLTE-3.2.0/plugins/jquery/jquery.min.js"></script>
  <!-- SweetAlert2 -->
<script src="<?= $main_url ?>asset/AdminLTE-3.2.0/AdminLTE-3.2.0/plugins/sweetalert2/sweetalert2.min.js"></script>
  <!-- Theme style -->
