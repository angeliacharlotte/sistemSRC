...
if (empty($_GET['tanggal_dari'])) {
    ...
    $result = mysqli_query($koneksi,"SELECT 
        ...
        j.customer,  
        bh.suplier,
        COALESCE(c.deskripsi, 'Area Bandung') AS area
    FROM (
        SELECT DISTINCT DATE(tgl_beli) AS tanggal, nama_brg FROM tbl_beli_detail_bandung WHERE DATE(tgl_beli) BETWEEN '$tanggal_awal_bulan' AND '$tanggal_akhir_bulan'
        UNION
        SELECT DISTINCT DATE(jh.tgl_jual) AS tanggal, jd.nama_brg
        FROM tbl_jual_head_bandung jh
        JOIN tbl_jual_detail_bandung jd ON jh.no_jual = jd.no_jual
    ...
    LEFT JOIN tbl_beli_head_bandung bh ON bh.no_beli = p.no_beli
    LEFT JOIN (
    ...
    LEFT JOIN tbl_barang_bandung b ON b.nama_barang = t.nama_brg
    LEFT JOIN tbl_customer_bandung c ON j.customer = c.nama
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Mutasi Stock Area Bandung</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
        ...
        <form method="POST" action="<?= $main_url ?>stock/bandung/mutasiStock_bandung_excel.php">
