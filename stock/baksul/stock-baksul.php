...
if (empty($_GET['tanggal_dari'])) {
    ...
    $result = mysqli_query($koneksi,"SELECT 
        ...
        b.stock,  
        bh.suplier,
        COALESCE('Area Baksul') AS area
    FROM (
        SELECT DISTINCT DATE(tgl_beli) AS tanggal, nama_brg FROM tbl_beli_detail_baksul WHERE DATE(tgl_beli) BETWEEN '$tanggal_awal_bulan' AND '$tanggal_akhir_bulan'
        UNION
        SELECT DISTINCT DATE(jh.tgl_jual) AS tanggal, jd.nama_brg
        FROM tbl_jual_head_baksul jh
        JOIN tbl_jual_detail_baksul jd ON jh.no_jual = jd.no_jual
    ...
    LEFT JOIN tbl_beli_head_baksul bh ON bh.no_beli = p.no_beli
    LEFT JOIN (
    ...
    LEFT JOIN tbl_barang_baksul b ON b.nama_barang = t.nama_brg
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Mutasi Stock Area Baksul</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
        ...
        <form method="POST" action="<?= $main_url ?>stock/baksul/mutasiStock_excel.php">
