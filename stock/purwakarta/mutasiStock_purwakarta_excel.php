...
$tanggal_dari = $_POST['tanggal_dari'];
    ...
    $result = mysqli_query($koneksi, "SELECT 
        ...
        j.customer, 
        bh.suplier,
        COALESCE(c.deskripsi, 'Area Purwakarta') AS area
    FROM (
...
$sheet->setCellValue('A1', 'MUTASI STOCK AREA PURWAKARTA');
...
header('Content-Disposition: attachment;filename="mutasi_stock_purwakarta.xlsx"');
