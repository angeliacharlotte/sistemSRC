...
if (empty($_GET['tanggal_dari'])) {
    ...
    FROM (
        SELECT DISTINCT DATE(tgl_beli) AS tanggal, nama_brg FROM tbl_beli_detail_cirebon WHERE DATE(tgl_beli) BETWEEN '$tanggal_awal_bulan' AND '$tanggal_akhir_bulan'BETWEEN '$tanggal_awal_bulan' AND '$tanggal_akhir_bulan'
        UNION
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Mutasi Stock Area Cirebon</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
        ...
        <form method="POST" action="<?= $main_url ?>stock/cirebon/mutasiStock_cirebon_excel.php">
