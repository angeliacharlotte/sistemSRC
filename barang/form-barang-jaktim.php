...
if (isset($_GET['msg'])){
    $msg = $_GET['msg'];
    $id = $_GET['id'];
    $sqlEdit = "SELECT * FROM tbl_barang_jaktim WHERE id_barang = '$id'";
...
if(isset($_POST['simpan'])){
    if($msg != ''){
        if (update_jaktim($_POST)){
            echo "
                <script>document.location.href = 'barang-jaktim.php?msg=updated';</script>            
            ";
        } else {
            echo "
                <script>document.location.href = 'barang-jaktim.php';</script>            
            ";
        }
    } else {
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= $main_url ?>barang/barang-jaktim.php">Barang</a></li>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="kode" class="form-control" id="kode" value="<?= $msg != '' ? $barang['id_barang'] : generateIdjaktim()  ?>" readonly>
                        </div>
                        <div class="form-group">
