        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <a href="<?= $main_url ?>barang/form-barang-bekasi.php" class="mr-2 btn btn-sm btn-primary float-right"><i class="fas fa-plus fa-sm"></i> Add Barang</a>
                </div>
                            ...
                            foreach($barang as $brg){ ?>
                                <tr>
                                    ...
                                    <td style="vertical-align: middle;" class="text-center">
                                        <a href="form-barang-bekasi.php?id=<?= $brg['id_barang'] ?>&msg=editing" class="btn btn-warning btn-sm" title="edit barang" ><i class="fas fa-pen"></i></a>
