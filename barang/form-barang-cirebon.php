...
if (isset($_GET['msg'])){
    $msg = $_GET['msg'];
    $id = $_GET['id'];
    $sqlEdit = "SELECT * FROM tbl_barang_cirebon WHERE id_barang = '$id'";
...
if(isset($_POST['simpan'])){
    if($msg != ''){
        if (update_cirebon($_POST)){
            echo "
                <script>document.location.href = 'barang-cirebon.php?msg=updated';</script>            
            ";
        } else {
            echo "
                <script>document.location.href = 'barang-cirebon.php';</script>            
            ";
        }
    } else {
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="kode" class="form-control" id="kode" value="<?= $msg != '' ? $barang['id_barang'] : generateIdcirebon()  ?>" readonly>
                        </div>
                        <div class="form-group">
