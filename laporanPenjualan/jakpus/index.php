...
if(empty($_GET['tanggal_dari'])) {  
  ...
  $result = mysqli_query($koneksi,"SELECT tbl_jual_detail_jakpus.*, tbl_jual_head_jakpus.customer, tbl_jual_head_jakpus.keterangan,  tbl_jual_head_jakpus.jml_bayar
        FROM tbl_jual_detail_jakpus JOIN tbl_jual_head_jakpus ON tbl_jual_detail_jakpus.no_jual = tbl_jual_head_jakpus.no_jual WHERE tbl_jual_detail_jakpus.tgl_jual = '$tanggal_hari_ini' ORDER BY tbl_jual_detail_jakpus.tgl_jual DESC");
}else if(empty($_GET['tanggal_sampai'])){
  $tanggal_dari = $_GET['tanggal_dari'];
  $tanggal_hari_ini = date('Y-m-d');
//   $tanggal_sampai = $_GET['tanggal_sampai'];
  $result = mysqli_query($koneksi,"SELECT tbl_jual_detail_jakpus.*, tbl_jual_head_jakpus.customer, tbl_jual_head_jakpus.keterangan,  tbl_jual_head_jakpus.jml_bayar
        FROM tbl_jual_detail_jakpus JOIN tbl_jual_head_jakpus ON tbl_jual_detail_jakpus.no_jual = tbl_jual_head_jakpus.no_jual WHERE tbl_jual_detail_jakpus.tgl_jual BETWEEN '$tanggal_dari' AND '$tanggal_hari_ini' ORDER BY tbl_jual_detail_jakpus.tgl_jual DESC");
}else{
    $tanggal_dari = $_GET['tanggal_dari'];
  $tanggal_sampai = $_GET['tanggal_sampai'];
  $result = mysqli_query($koneksi,"SELECT tbl_jual_detail_jakpus.*, tbl_jual_head_jakpus.customer, tbl_jual_head_jakpus.keterangan,  tbl_jual_head_jakpus.jml_bayar
        FROM tbl_jual_detail_jakpus JOIN tbl_jual_head_jakpus ON tbl_jual_detail_jakpus.no_jual = tbl_jual_head_jakpus.no_jual WHERE tbl_jual_detail_jakpus.tgl_jual BETWEEN '$tanggal_dari' AND '$tanggal_sampai' ORDER BY tbl_jual_detail_jakpus.tgl_jual DESC");
}
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Laporan Penjualan Area Jakarta Pusat</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
        ...
        <form method="POST" action="<?= $main_url ?>laporanPenjualan/jakpus/rekap_penjualan_excel.php">
