...
$result = mysqli_query($koneksi,"SELECT tbl_jual_detail_jaksel.*, tbl_jual_head_jaksel.customer, tbl_jual_head_jaksel.keterangan,  tbl_jual_head_jaksel.jml_bayar
...
$sheet->setCellValue('A1', 'REKAP PENJUALAN AREA JAKARTA SELATAN');
...
header('Content-Disposition: attachment;filename="rekap_penjualan_jaksel.xlsx"');
