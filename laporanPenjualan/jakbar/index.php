...
if(empty($_GET['tanggal_dari'])) {  
  ...
  $result = mysqli_query($koneksi,"SELECT tbl_jual_detail_jakbar.*, tbl_jual_head_jakbar.customer, tbl_jual_head_jakbar.keterangan,  tbl_jual_head_jakbar.jml_bayar
        FROM tbl_jual_detail_jakbar JOIN tbl_jual_head_jakbar ON tbl_jual_detail_jakbar.no_jual = tbl_jual_head_jakbar.no_jual WHERE tbl_jual_detail_jakbar.tgl_jual = '$tanggal_hari_ini' ORDER BY tbl_jual_detail_jakbar.tgl_jual DESC");
}else if(empty($_GET['tanggal_sampai'])){
  $tanggal_dari = $_GET['tanggal_dari'];
  $tanggal_hari_ini = date('Y-m-d');
//   $tanggal_sampai = $_GET['tanggal_sampai'];
  $result = mysqli_query($koneksi,"SELECT tbl_jual_detail_jakbar.*, tbl_jual_head_jakbar.customer, tbl_jual_head_jakbar.keterangan,  tbl_jual_head_jakbar.jml_bayar
        FROM tbl_jual_detail_jakbar JOIN tbl_jual_head_jakbar ON tbl_jual_detail_jakbar.no_jual = tbl_jual_head_jakbar.no_jual WHERE tbl_jual_detail_jakbar.tgl_jual BETWEEN '$tanggal_dari' AND '$tanggal_hari_ini' ORDER BY tbl_jual_detail_jakbar.tgl_jual DESC");
}else{
    $tanggal_dari = $_GET['tanggal_dari'];
  $tanggal_sampai = $_GET['tanggal_sampai'];
  $result = mysqli_query($koneksi,"SELECT tbl_jual_detail_jakbar.*, tbl_jual_head_jakbar.customer, tbl_jual_head_jakbar.keterangan,  tbl_jual_head_jakbar.jml_bayar
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Laporan Penjualan Area Jakarta Barat</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right"><li class="breadcrumb-item"><a href="<?= $main_url ?>penjualan/jakbar">Penjualan</a></li>
    ...
    <section class="content">
        ...
        <form method="POST" action="<?= $main_url ?>laporanPenjualan/jakbar/rekap_penjualan_excel.php">
