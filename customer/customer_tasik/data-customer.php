  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Customer Area Tasikmalaya</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <a href="<?= $main_url ?>customer/customer_tasik/add-customer.php" class="btn btn-sm btn-primary float-right"><i class="fas fa-plus fa-sm"></i> Add Customer</a>
                </div>
