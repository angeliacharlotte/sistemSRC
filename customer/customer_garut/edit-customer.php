...
$sqlEdit = "SELECT * FROM tbl_customer_garut WHERE id_customer = $id";
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= $main_url ?>customer/customer_garut/data-customer.php">Customer</a></li>
