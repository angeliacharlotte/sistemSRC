...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Laporan Margin Area Jakarta Timur</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
window.onload = hitungTotalMargin;
        ...
        <form method="POST" action="<?= $main_url ?>laporanMargin/jaktim/rekap_penjualan_excel.php">
