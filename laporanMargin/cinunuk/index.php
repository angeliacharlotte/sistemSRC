...
$result = mysqli_query($koneksi, "
    SELECT p.*, 
        (
            SELECT IFNULL(SUM(penjualan),0) FROM tbl_setoran
...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Laporan Margin Area Cinunuk</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right"><li class="breadcrumb-item"><a href="<?= $main_url ?>setoran/form-setoran_cinunuk.php">Setoran</a></li>
    ...
    <section class="content">
                ...
                <div class="card-body table-responsive p-3">
                    ...
                    <table class="table table-hover text-nowrap mt-2 text-center" id="tabel-penjualan">
                        ...
                        if ($result && mysqli_num_rows($result) > 0) {
                            ...
                            $result_first = mysqli_query($koneksi, "SELECT IFNULL(SUM(penjualan),0) AS total_penjualan FROM tbl_setoran WHERE tgl_setoran LIKE '$bulan%'");
                            ...
                            $q = mysqli_query($koneksi, "SELECT IFNULL(SUM(penjualan),0) AS total_penjualan FROM tbl_setoran WHERE tgl_setoran LIKE '$bulan%'");
        ...
        <form method="POST" action="<?= $main_url ?>laporanMargin/cinunuk/rekap_margin_excel.php">
