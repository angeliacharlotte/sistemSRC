    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right"><li class="breadcrumb-item"><a href="<?= $main_url ?>penjualan/tasikmalaya">Penjualan</a></li>
...
window.onload = hitungTotalMargin;
        ...
        <form method="POST" action="<?= $main_url ?>laporanMargin/tasikmalaya/rekap_penjualan_excel.php">
