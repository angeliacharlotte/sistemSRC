    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="card-title"><i class="fas fa-plus fa-sm"></i> Add Sales</h3>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-8 mb-3">
                        ...
                        <div class="form-group">
                            <label for="level">Operator Area</label>
                            <select name="level" id="level" class="form-control" required>
                                <option value="">--Area Sales--</option>
                                <option value="14">Bandung</option>
                                <option value="14">Purwakarta</option>
                                <option value="14">Bandung2</option>
                                <option value="14">Bekasi</option>
                                <option value="14">Cirebon</option>
                                <option value="14">Garut</option>
                                <option value="14">Jakarta Barat</option>
                                <option value="14">Jakarta Pusat</option>
                                <option value="14">Jakarta Selatan</option>
                                <option value="14">Jakarta Timur</option>
                                <option value="14">Tangerang</option>
                                <option value="14">Tasik</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label for="address">Address</label>
                            <textarea name="address" id="address" cols="" rows="3" class="form-control" placeholder="masukkan alamat" required></textarea>
