                 ...
                 <table class="table table-hover text-nowrap">
                    ...
                    foreach($users as $user) :?>
                        ...
                        <td>
                            ...
                            <a href="del-user.php?id=<?= $user['userid'] ?>&foto=<?= $user['foto'] ?>" class="btn btn-sm btn-danger" title="hapus user" onclick="return confirm ('Anda yakin hapus user ?')"><i class="fas fa-user-times"></i></a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
                    </tbody>
